# Git'i Anlayın, Ezberlemeyin

**Görev Kimliği:** `y1t1-002`
**Tahmini süre:** 8 saat
**Modül:** Git
...
- **MIT - The Missing Semester of Your CS Education (2026)** (birincil): https://missing.csail.mit.edu/2026/
- **Pro Git (official Git book)** (referans): https://git-scm.com/book/en/v2
...
1. Birleştirme ve rebase: Her birini ne zaman seçersiniz?
2. Zorla itmek neden tehlikelidir?
3. Git normal bir klasör kopyasının saklamadığı neyi saklar?
...
- Reflog'u kullanarak hatalı bir commit'den canlı kurtarma talebinde bulunun.
- Çırak sadece komut tariflerini biliyorsa onaylamayın.
