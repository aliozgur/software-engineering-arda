# Build Your Engineering Workstation

**Task ID:** `y1t1-001`  
**Estimated effort:** 6 hours  
**Module:** Developer Foundations

## Why this task exists

Create a reproducible development environment and become comfortable operating from a terminal.
...
1. Install Git, Python, a code editor, and a Unix-like shell environment.
2. Create a dotfiles or setup-notes repository.
3. Use shell navigation, pipes, redirection, environment variables, permissions and process inspection.
4. Document every installation and verify the environment from a clean terminal.
...
- [ ] A setup README can reproduce the environment.
- [ ] At least 15 shell commands are demonstrated with explanations.
- [ ] No secrets or tokens are committed.
- [ ] Mentor can ask the apprentice to locate a process, inspect PATH and redirect output without a GUI.
...
1. Which shell concepts were initially unintuitive?
2. What part of the environment is machine-specific?
3. How would you reproduce this setup on another computer?
...
- Ask the apprentice to perform three terminal tasks live without copy/paste.
- Review whether the README is reproducible rather than merely descriptive.
