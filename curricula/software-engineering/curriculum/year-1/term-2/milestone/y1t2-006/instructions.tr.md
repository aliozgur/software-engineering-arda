# 1. Dönüm Noktası: Kişisel Bilgi API

**Görev Kimliği:** `y1t2-006`
**Tahmini süre:** 28 saat
**Modül:** Dönüm Noktası

## Bu görev neden var?

Birinci yılın temellerini bağımsız olarak kanıtlanabilir tek bir ürüne entegre edin.
...
- [ ] README'den yeni klon başlatılabilir.
- [ ] Temel kullanım senaryoları uçtan uca çalışır.
- [ ] Veritabanı kısıtlamaları ve testleri önemli değişmezleri korur.
- [ ] En az bir performans ölçümü ve bir erişilebilirlik kontrolü belgelenmiştir.
- [ ] Sürüm v0.1.0 olarak etiketlendi.
...
1. Hangi tasarım kararını değiştirirdiniz?
2. Entegrasyon sırasında ne başarısız oldu?
3. Bu yıl mühendislik gelişiminizi en iyi gösteren kanıtlar nelerdir?
...
- 30 dakikalık bir tasarım/demo incelemesi çalıştırın.
- Gözlemlenen bir zayıflığa dayanarak en az bir takip mücadelesi oluşturun.
