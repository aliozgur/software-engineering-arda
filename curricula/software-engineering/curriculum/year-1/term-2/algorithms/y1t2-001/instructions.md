...
Develop the ability to reason about correctness and asymptotic cost.
...
- **MIT 6.006 - Introduction to Algorithms** (primary): https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-fall-2011/
...
1. Study asymptotic analysis, sorting, hashing, trees and graph basics from MIT 6.006 selections.
2. Implement representative structures/algorithms in Python.
3. Benchmark two algorithms with different asymptotic behavior.
4. Write one correctness argument using invariants or induction-style reasoning.
...
- [ ] Complexities are justified rather than guessed.
- [ ] Benchmark results are graphed or tabulated and interpreted.
- [ ] Apprentice can explain when Big-O hides practically important constants.
...
1. Where did theoretical and measured performance differ?
2. What makes an algorithm correct, beyond passing tests?
...
- Give an unfamiliar input-size scenario and ask apprentice to choose an approach.
