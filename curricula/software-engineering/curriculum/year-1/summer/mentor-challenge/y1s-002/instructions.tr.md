# Mentor Görevi: Yavaş Bir Sorguyu Teşhis Edin

**Görev Kimliği:** `y1s-002`
**Tahmini süre:** 8 saat
**Modül:** Mentor Yarışması

## Bu görev neden var?

Öğretici şeklinde bir çözüm olmadan araştırma yapın.
...
1. Mentor bir PostgreSQL şeması/veri seti ve yavaş bir sorgu sağlar.
2. Herhangi bir şeyi değiştirmeden önce hipotezler oluşturun.
3. EXPLAIN ANALYZE ile ölçün.
4. Bir veya daha fazla değişikliği uygulayın ve yeniden ölçün.
5. Kanıtlar ve ödünleşimlerle olay tarzı bir teşhis yazın.
...
- [ ] Öncesi/sonrası ölçümleri mevcut.
- [ ] Değişiklikler haklı.
- [ ] 'Her yere dizin ekle' çözümü yok.
- [ ] Rapor gözlemleri, hipotezleri, deneyleri ve sonuçları ayırır.
...
1. Hangi hipotez yanlıştı?
2. Hangi ek üretim verilerini istersiniz?
...
- Amaçlanan düzeltmeyi erken açıklamayın.
- Araştırma kalitesini nihai performans kadar ağır bir şekilde puanlayın.
