# Bağımlılık ve Tedarik Zinciri Hijyeni

**Görev Kimliği:** `y4t1-006`
**Tahmini süre:** 12 saat
**Modül:** Sürüm

## Bu görev neden var?

Bağımlılıkları ele alın ve girdileri ürünün risk yüzeyinin bir parçası olarak oluşturun.
...
1. Bir projedeki envanter doğrudan bağımlılıkları.
2. Ekosistem için mevcut olan lisansları ve bilinen güvenlik açığı araçlarını belirleyin.
3. Bağımlılıkları uygun şekilde sabitleyin/kilitleyin.
4. Otomatik bir bağımlılık/güvenlik kontrolü oluşturun.
5. Belge güncelleme politikası ve acil durum yama süreci.
...
- [ ] Bağımlılık envanteri tekrarlanabilir.
- [ ] Yapı yapılandırmasında sır yok.
- [ ] Kilit dosyaları ekosistemin onları beklediği yerde işlenir.
- [ ] Politika, rutin güncellemeyi acil güvenlik yanıtından ayırır.
...
1. Geçişli bağımlılıklardan kaynaklanan risk nedir?
2. 'En son' tekrarlanabilirliğe neden zarar verebilir?
...
- Çıraktan bir bağımlılığın kaldırılmasını/değiştirilmesini değerlendirmesini isteyin.
