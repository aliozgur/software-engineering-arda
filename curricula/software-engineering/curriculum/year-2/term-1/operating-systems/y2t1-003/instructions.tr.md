# İş Parçacıkları, Senkronizasyon ve Eşzamanlılık Hataları

**Görev Kimliği:** `y2t1-003`
**Tahmini süre:** 20 saat
**Modül:** İşletim Sistemleri

## Bu görev neden var?

Yalnızca tanımları okumak yerine yarışları, kilitlenmeleri, kilitlenmeleri ve koordinasyonu deneyimleyin.
...
1. Kasıtlı olarak müstehcen bir sayaç/iş kuyruğu programı oluşturun.
2. Irkı yeniden oluşturun ve neden deterministik olmadığını açıklayın.
3. Uygun senkronizasyonu kullanarak sorunu düzeltin.
4. Küçük bir kilitlenme örneği oluşturun ve belgelenmiş bir kilitleme sırası kuralını kullanarak bunu ortadan kaldırın.
5. İş parçacıklarını işlemler ve eşzamansız G/Ç ile karşılaştırın.
...
- [ ] Irk stres altında tekrarlanabilir.
- [ ] Düzeltme test edildi.
- [ ] Kilitlenmenin nedeni bekleme ilişkileriyle açıklanır.
- [ ] Çırak her kilit tarafından korunan bir değişmezi belirtebilir.
...
1. Kilit eklemek neden hala yanlış yazılım üretebiliyor?
2. Eşzamanlılık hatalarının yeniden üretilmesini zorlaştıran şey nedir?
...
- İnceleme sırasında ikinci bir paylaşılan değişkeni tanıtın ve değişmezlerin nasıl değiştiğini sorun.
