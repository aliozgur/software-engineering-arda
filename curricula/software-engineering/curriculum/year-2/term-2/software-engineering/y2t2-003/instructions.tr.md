# Modülerlik, Yeniden Düzenleme ve Mimari

**Görev Kimliği:** `y2t2-003`
**Tahmini süre:** 18 saat
**Modül:** Yazılım Mühendisliği

## Bu görev neden var?

Tasarım kalitesini kalıp söz dağarcığı yerine değiştirilebilirlik yoluyla tanıyın.
...
1. Kasıtlı olarak karışık bir uygulamayı veya daha eski bir projeyi ele alalım.
2. Sorumlulukları belirleyin, bağlantı kurun ve sıcak noktaları değiştirin.
3. Yeniden düzenlemeden önce karakterizasyon testleri ekleyin.
4. Daha net modül sınırlarına doğru yeniden düzenleme yapın.
5. Bir mimari kararını ve reddedilen alternatifleri açıklayan bir ADR yazın.
...
1. En çok acıya hangi bağlantı neden oldu?
2. Eklemek yerine hangi soyutlamayı kaldırdınız?
...
- Yeniden düzenleme sonrasında yeni bir özellik isteyin; İddia edilen sınırların yardımcı olup olmadığını değerlendirin.
