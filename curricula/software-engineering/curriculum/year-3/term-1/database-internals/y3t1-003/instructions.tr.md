# Veritabanı Sistemleri: Depolama ve Dizinler

**Görev Kimliği:** `y3t1-003`
**Tahmini süre:** 24 saat
**Modül:** Veritabanı Dahili Öğeleri

## Bu görev neden var?

Veritabanı motorlarının neden bu şekilde davrandığını anlayın.
...
1. Depolama, arabellek havuzları ve dizinler hakkındaki CMU materyalini inceleyin.
2. Basitleştirilmiş bir sayfa/önbellek veya B+ağaç alıştırması uygulayın veya lisanslama/kurs kuralları izin veriyorsa uygun BusTub proje bölümlerini tamamlayın.
3. B ağacı ve karma dizini iş yüklerini kavramsal ve deneysel olarak karşılaştırın.
4. Arabellek yönetimini işletim sistemi/dosya sistemi önbelleğine bağlayan bir not yazın.
...
- [ ] Uygulamanın testleri vardır.
- [ ] Veri yapısı değişmezleri belgelenmiştir.
- [ ] Denemede birden fazla iş yükü şekli kullanılıyor.
- [ ] Çırak, veritabanı sayfalarının ve arabellek havuzlarının neden var olduğunu açıklıyor.
...
1. Dizin aramasının ardındaki maliyet modeli nedir?
2. Neden çift ara belleğe alma meydana gelebilir?
...
- Sorgudan depolamaya kadar bir sayfa aramasını beyaz tahtaya aktarın.
