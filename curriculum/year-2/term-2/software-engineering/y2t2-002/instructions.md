...
Learn to define the problem before designing the solution.
...
1. Interview mentor as a mock stakeholder for a small application.
2. Write problem statement, actors, goals, non-goals and constraints.
3. Create 8-12 testable functional requirements and 5 quality attributes.
4. Model core domain concepts and invariants.
5. Record open questions and decisions.
...
- [ ] Requirements are testable and avoid implementation detail where possible.
- [ ] Non-goals constrain scope.
- [ ] Domain model captures rules, not just database tables.
- [ ] Quality attributes have measurable interpretations.
...
1. Which requirement was ambiguous until questioned?
2. What did you intentionally exclude?
...
- Change one stakeholder requirement after the draft and observe impact analysis.
