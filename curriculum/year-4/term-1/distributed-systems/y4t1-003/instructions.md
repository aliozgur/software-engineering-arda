# Replication and Consensus Laboratory
...
Implement enough of a replicated system to understand leader election, logs and failure handling.
...
1. Complete selected MIT 6.5840 labs or implement a scoped Raft-inspired educational system according to course rules.
2. Test leader failure and recovery.
3. Test message delay/reordering in the harness.
4. Explain safety properties in writing.
5. Record debugging techniques for nondeterministic failures.
...
- [ ] Automated failure tests exist.
- [ ] No claims of production-ready consensus.
- [ ] Safety reasoning is understandable.
- [ ] Apprentice can explain why 'two leaders' observations may or may not violate safety depending on term/time.
...
1. Which bug only appeared under timing variation?
2. Why is consensus more than electing a leader?
...
- Do not provide implementation solutions; use hints and conceptual questions.
