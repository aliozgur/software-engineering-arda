# Read and Contribute to an Open-Source Project
...
Learn to enter an unfamiliar codebase and collaborate through public engineering conventions.
...
1. Select an active, beginner-accessible open-source repository.
2. Read contribution guide, license and issue tracker.
3. Build/test the project locally.
4. Submit at least one meaningful documentation/test/small-code contribution or, if not accepted, prepare a reviewable patch.
5. Write a codebase map showing key modules and data flow.
...
- [ ] Contribution follows project conventions.
- [ ] Patch/PR is small and justified.
- [ ] Journal records review feedback and response.
- [ ] Apprentice can explain the project's license at a practical level.
...
1. What was harder about someone else's codebase?
2. How did maintainers communicate quality expectations?
...
- Review interaction quality and humility, not whether a PR was merged.
