...
Replace intuition-driven optimization with measurement.
...
1. Define a workload and performance objective.
2. Create a repeatable load test.
3. Profile CPU/memory/database behavior.
4. Identify one bottleneck and improve it.
5. Re-run the same workload and report before/after plus trade-offs.
6. Document why another apparent optimization was rejected.
...
- [ ] Test is repeatable.
- [ ] Measurements include latency distribution, not only averages.
- [ ] Improvement is evidenced.
- [ ] Correctness is revalidated after optimization.
...
1. What was the bottleneck before measurement? Were you right?
2. What resource becomes next bottleneck?
...
- Change workload shape and see whether optimization still helps.
